        ...
        "parameters": [
            {
                ...
                "schema": {
                    ...
                    "properties": {
                        "client_token": {
                            "type": "string",
                            "description": "Bot client token for authentication",
                        },
                        "twitch_username": {
                            "type": "string",
                        ...
                        "battle_tag": {
                            "type": "string",
                            "description": "W3Champions BattleTag",
                        },
                        "race": {
                            "type": "string",
                            "description": "Optional race (orc, human, undead, nightelf, random)",
                        },
                    },
...
def create_signup():
    try:
        ...
        setting = koth_blueprint.koth_app_service.settings_app_service.get_setting(
            "KOTH_NIGHTBOT_TOKEN"
        )
        ...
        "parameters": [
            {
                ...
                "schema": {
                    ...
                    "properties": {
                        "twitch_username": {
                            "type": "string",
                            "description": "Twitch username (optional)",
                        },
                        "battle_tag": {
                            "type": "string",
                            "description": "W3Champions BattleTag",
                        ...
                        "race": {
                            "type": "string",
                            "description": "Preferred race (optional): orc, human, undead, nightelf, random",
                        },
                    },
                    "required": ["battle_tag"],
                },
...
@swag_from(
    {
        ...
        "parameters": [
            {"name": "signup_id", "in": "path", "type": "integer", "required": True},
            {
                ...
                "schema": {
                    "type": "object",
                    "properties": {"bracket": {"type": "integer", "enum": [1, 2, 3]}},
                    "required": ["bracket"],
                },
            },
        ],
...
def update_signup_bracket(signup_id):
    try:
        data = request.json
        signup = koth_blueprint.koth_app_service.update_signup_bracket(
            signup_id, data.get("bracket")
        )
                ...
                "schema": {
                    ...
                    "properties": {
                        ...
                        "game_mode": {
                            "type": "string",
                            "example": "2v1",
                            "description": "e.g., 1v1, 2v1, 2v2, 3v1, FFA",
                        },
...
def get_bracket_kings(event_id):
    try:
        ...
        return jsonify(
            {k: [king.to_dict() for king in v] for k, v in kings.items()}
        ), 200
    except Exception as e:
        logger.error(e)
        return jsonify({"error": str(e)}), 500

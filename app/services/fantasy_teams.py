...
class FantasyTeamService(BaseService):
    def add(self, fantasy_team: FantasyTeamCreate):
    ...
    def update(self, fantasy_team_id, fantasy_team: FantasyTeamUpdate):
        with self.get_session() as session:
    ...
    def create_fantasy_team(self, team: FantasyTeamCreate):
        return self.add(team)

    def update_fantasy_team(self, team_id: int, team: FantasyTeamUpdate):

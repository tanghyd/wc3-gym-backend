...
def perform_calculation(season_id: int):
    ...
    try:
            ...
            for singleSeries in series:
                try:
                    if (
                        ...
                        continue
                    calculatedSeries = (
                        score_blueprint.score_app_service.calculateSeriesScore(
                            singleSeries
                        )
                    )
                except Exception as e:
                ...
                score_blueprint.series_app_service.update_series(
                    calculatedSeries.id, calculatedSeries
                )
        ...
        for team in teams.values():
            score_blueprint.score_app_service.updateTeamScore(team, season_id)

...
from src.schemas.base import APISchema, EmptyToNone, IntToStr, IsoDate
...
class Season(APISchema):
    ...
    discordRole: Annotated[str | None, IntToStr] = None
    ...
    def from_dbseason(cls, season):
        ...
        return cls(
            ...
            maps=[Map.from_dbmap(map_season.map) for map_season in season.maps if map_season and map_season.map] if season.maps else [],

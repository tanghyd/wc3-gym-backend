...
_ALL_MODELS = [
    Map, W3CStats, Settings,
    KothSignup, KothMatchParticipant, KothMatch, KothEvent,
    Season, UserTeamSeasonStats, User, SeasonInfo,
    TeamReduced, Team, Match, Series, DraftSeries,
...
__all__ = [
    'APISchema', 'Map', 'W3CStats', 'Settings',
    'KothSignup', 'KothMatchParticipant', 'KothMatch', 'KothEvent',
    'Season', 'UserTeamSeasonStats', 'User', 'SeasonInfo',
    'Team', 'TeamReduced', 'Match', 'Series', 'DraftSeries',
    'FantasyTeam', 'FantasyBet', 'PlayerCareerStats',
]
